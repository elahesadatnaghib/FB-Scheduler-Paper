...
\tablehead{
\colhead{Survey} & \colhead{OSF} & \colhead{median Airmass} & \colhead{dithered} & \colhead{$r$\%} & \colhead{$g$\%}
}
\startdata
FB & 0.705 & 1.1 & yes & 63.7 & 47.0 \\
