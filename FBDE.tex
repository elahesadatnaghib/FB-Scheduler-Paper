...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\linewidth]{Figures/TDcurve.png}
\end{center}
\caption{}
...
\caption{A zoomed-in crop of the co-added depth coverage of Figure \ref{fig_10yrs_skymap} in the \textit{g}-band. The smooth coverage of the Modified Feature-Based scheduler (left) versus the granular pattern of \textit{astro-lsst-01-2013} (right) offers a more uniform co-added depth in the micro-scale coverage quality.}
\label{fig_zoomin_g}
\end{figure}
